...
export const CalendarView: React.FC<CalendarViewProps> = ({
  ...
  }, [isGoogleCalendarModalOpen, isEventModalOpen, selectedDateForDetail, weatherModalDate, onClose]);
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pb-4 border-b-2 border-yellow-200/80">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap w-full lg:w-auto justify-end">
            ...
            <button
              id="btn-import-google-calendar"
              onClick={() => {
                sound.playTap();
                setIsGoogleCalendarModalOpen(true);
              }}
              className="px-3.5 py-2 bg-white hover:bg-slate-50 text-indigo-950 font-black text-xs rounded-2xl border-2 border-indigo-200 hover:border-indigo-400 shadow-sm flex items-center gap-2 active:scale-95 transition-all cursor-pointer"
